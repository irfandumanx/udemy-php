            ...
            <div class="mainbar-row rbt-navigation-center align-items-center">
                <div class="header-left rbt-header-content">
                    <div class="header-info">
                        <div class="logo">
                            <a href="index.html">
                                <img style="margin-right: 16px;" src="assets/images/logo/logo.svg" alt="Udemy Logo">
                            </a>
                        </div>
                    </div>
                    <div class="header-info">
    ...
    <div class="inner-wrapper">
        <div class="inner-top">
            <div class="content">
                <div class="logo">
                    <a href="index.html">
                        <img src="assets/images/logo/logo.svg" alt="Udemy Logo">
                    </a>
                </div>
                <div class="rbt-btn-close">
        ...
        <div class="row gy-4 row--30 justify-content-center">
            ...
            <div id="login-form" class="col-lg-6">
                <div class="rbt-contact-form contact-form-style-1 max-width-auto">
                    <span id="login-error" class="d-block text-center max-width-auto color-danger">böyle mühendisliğin amk</span>
            ...
            <div id="register-form" class="d-none col-lg-6">
                <div class="rbt-contact-form contact-form-style-1 max-width-auto">
