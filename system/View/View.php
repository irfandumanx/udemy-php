...
class View implements RendererInterface
{
    ...
    /**
     * The name of the layouts being used, if any.
    ...
    /**
     * Specifies that the current view should extend an existing layouts.
     *
     * @return void
     */
    ...
    /**
     * Starts holds content for a section within the layouts.
     *
    ...
    /**
     * Used within layouts views to include additional views.
     *
     * @param bool $saveData
     */
